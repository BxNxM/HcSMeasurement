...
function init() {
    ...
    ########################## SET THESE ###########################
    known_args=("man" "debug" "run" "usrun" "kill" "monitor" "cleanup" "lmess")                             # valid arg list - add new args - call with -- expl: --man
    known_args_subs_pcs=(0 0 0 0 0 0 0 0)                                               # values for args - expl: --man -> 0, --example -> 1 etc.
